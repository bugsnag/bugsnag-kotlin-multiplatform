...
import com.bugsnag.cocoa.BugsnagDeviceWithState
import kotlinx.cinterop.ExperimentalForeignApi
import platform.Foundation.NSNumber

public actual typealias PlatformDeviceWithState = BugsnagDeviceWithState
...
public actual value class DeviceWithState internal constructor(
    ...
    public actual var runtimeVersions: MutableMap<String, Any>?
        get() = native.runtimeVersions as MutableMap<String, Any>?
        set(value) {
            native.runtimeVersions = value as Map<Any?, *>?
        }
