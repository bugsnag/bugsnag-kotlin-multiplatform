...
public actual typealias PlatformDeviceWithState = JsDeviceWithState
...
public actual value class DeviceWithState internal constructor(
    ...
    public actual var runtimeVersions: MutableMap<String, Any>?
        get() = native.runtimeVersions.toSafeMetadata()
        set(value) {
            native.runtimeVersions = value?.convertToDynamic()
        }
