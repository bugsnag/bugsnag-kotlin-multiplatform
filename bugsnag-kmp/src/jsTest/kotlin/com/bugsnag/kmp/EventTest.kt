...
internal class EventTest {
    ...
    fun eventTest() {
        ...
        testEvent.apply {
            ...
            device.jailbroken = DEVICE_JAILBROKEN
            device.id = DEVICE_ID
            ...
            device.totalMemory = DEVICE_TOTAL_MEMORY
        }
        ...
        assertEquals(DEVICE_JAILBROKEN, jsEvent.asDynamic().device.jailbroken)
        ...
        assertEquals(DEVICE_TOTAL_MEMORY, jsEvent.asDynamic().device.totalMemory)
    }
    ...
    companion object {
        ...
        const val DEVICE_JAILBROKEN = false
        ...
        const val DEVICE_TOTAL_MEMORY = 1000L
    }
}
