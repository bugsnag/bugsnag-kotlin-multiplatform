...
internal class EventTest {
    ...
    fun eventTest() {
        ...
        testEvent.app.binaryArch = APP_BINARYARCH
        testEvent.app.id = APP_ID
        ...
        testEvent.app.isLaunching = APP_ISLAUNCHING
        ...
        assertEquals(APP_BINARYARCH, jsEvent.asDynamic().app.binaryArch)
        assertEquals(APP_ID, jsEvent.asDynamic().app.id)
        ...
        assertEquals(APP_ISLAUNCHING, jsEvent.asDynamic().app.isLaunching)
    }
    ...
    companion object {
        ...
        const val APP_ISLAUNCHING = false
    }
}
